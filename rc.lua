...
-- beautiful.init("/usr/share/awesome/themes/zenburn/theme.lua")
   beautiful.init(".config/awesome/themes/awesome1/theme.lua")
...
for s = 1, screen.count() do
    ...
    tags = {}
tagnames = { " ₁ .desktop", " ₂ .inet", "   ₃ .xterm","   ₄ .code", "   ₅ .skype", "   ₆ .mail ", " ₇  .test" }
-- ༺ 
--  ༻   
taglayouts = {
        awful.layout.suit.tile.left,
...
awful.rules.rules = {
    ...
    -- Set programs to always map on tags number 1 of screen 1.
     { rule = { class = "Vlc" },
    ...
    -- Set Terminal to always map on tags number 3 of screen 1.
     { rule = { class = "Gnome-terminal" },
       properties = { tag = tags[1][3] } },

    -- Set Gedit to always map on tags number 4 of screen 1.
     { rule = { class = "Gedit" },
    ...
    -- Set Evolution to always map on tags number 6 of screen 1.
     { rule = { class = "Evolution" },
       properties = { tag = tags[1][6] } },

   -- Set Any "man" instantiation to always map on tags number 7 of screen 1.
     { rule = { class = "man" },
       properties = { tag = tags[1][6] } },
